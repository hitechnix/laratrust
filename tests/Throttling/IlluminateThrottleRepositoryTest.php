...
namespace Hitechnix\Laratrust\Tests\Throttling;
...
use Hitechnix\Laratrust\Throttling\EloquentThrottle;
...
class IlluminateThrottleRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->model = m::mock('Hitechnix\Laratrust\Throttling\EloquentThrottle');
        ...
        $this->throttle = m::mock(
            'Hitechnix\Laratrust\Throttling\IlluminateThrottleRepository[createModel]',
            [$this->users]
        );
    ...
    {
        $throttle = m::mock('Hitechnix\Laratrust\Throttling\IlluminateThrottleRepository[createModel]', [
    ...
    {
        $first = m::mock('Hitechnix\Laratrust\Throttling\EloquentThrottle');
    ...
    {
        $last = m::mock('Hitechnix\Laratrust\Throttling\EloquentThrottle');
