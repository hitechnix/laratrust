...
class IlluminateReminderRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->reminders = m::mock('Hitechnix\Laratrust\Reminders\IlluminateReminderRepository[createModel]', [$this->users]);
    ...
    {
        $user = m::mock('Hitechnix\Laratrust\Users\EloquentUser');
