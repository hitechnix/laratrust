...
namespace Hitechnix\Laratrust\Tests;
...
use Hitechnix\Laratrust\Roles\RoleRepositoryInterface;
use Hitechnix\Laratrust\Users\UserRepositoryInterface;
use Hitechnix\Laratrust\Activations\ActivationInterface;
use Hitechnix\Laratrust\Checkpoints\CheckpointInterface;
use Hitechnix\Laratrust\Reminders\ReminderRepositoryInterface;
use Hitechnix\Laratrust\Throttling\ThrottleRepositoryInterface;
use Hitechnix\Laratrust\Activations\ActivationRepositoryInterface;
use Hitechnix\Laratrust\Persistences\PersistenceRepositoryInterface;
...
class LaratrustTest extends TestCase
{
    ...
    public function an_exception_will_be_thrown_when_calling_methods_which_are_only_available_when_a_user_is_logged_in()
    {
        ...
        $this->expectExceptionMessage('Method Hitechnix\Laratrust\Laratrust::getRoles() can only be called if a user is logged in.');
    ...
    {
        $this->expectException(\BadMethodCallException::class);
        $this->expectExceptionMessage('Call to undefined method Hitechnix\Laratrust\Laratrust::methodThatDoesntExist()');
