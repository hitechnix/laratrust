...
namespace Hitechnix\Laratrust\Tests\Users;
...
class IlluminateUserRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->model = m::mock('Hitechnix\Laratrust\Users\EloquentUser');
        $this->model->shouldReceive('newQuery')->andReturn($this->query);

        $this->users = m::mock('Hitechnix\Laratrust\Users\IlluminateUserRepository[createModel]', [
            $this->hasher,
        ]);
    ...
    {
        $users = m::mock('Hitechnix\Laratrust\Users\IlluminateUserRepository[createModel,findById]', [
    ...
    {
        return m::mock('Hitechnix\Laratrust\Users\EloquentUser');
    }
}
