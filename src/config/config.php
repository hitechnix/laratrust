...
return [
    ...
    */
    ...
    'users' => [
        'model' => 'Hitechnix\Laratrust\Users\EloquentUser',
    ],
    ...
    */
    ...
    'roles' => [
        'model' => 'Hitechnix\Laratrust\Roles\EloquentRole',
    ],
    ...
    | permission types.
    |
    | 'Hitechnix\Laratrust\Permissions\StandardPermissions'
    | 'Hitechnix\Laratrust\Permissions\StrictPermissions'
    |
    ...
    */
    ...
    'permissions' => [
        'class' => 'Hitechnix\Laratrust\Permissions\StandardPermissions',
    ],
    ...
    */
    ...
    'persistences' => [
        'model' => 'Hitechnix\Laratrust\Persistences\EloquentPersistence',
    ...
    */
    ...
    'activations' => [
        'model' => 'Hitechnix\Laratrust\Activations\EloquentActivation',
    ...
    */
    ...
    'reminders' => [
        'model' => 'Hitechnix\Laratrust\Reminders\EloquentReminder',
    ...
    */
    ...
    'throttling' => [
        'model' => 'Hitechnix\Laratrust\Throttling\EloquentThrottle',
